...
class HiddenMarkovTrainer(hiddenStates:Array[String],observableStates:Array[String]) {
  ...
  def train(observations:Array[String],epsilon:Double=0.0001, maxIterations:Int=1000):HiddenMarkovModel = {
...
object HiddenMarkov {
  ...
  def train(hiddenStates:Array[String],observableStates:Array[String],observations:Array[String],epsilon:Double=0.0001, maxIterations:Int=1000):HiddenMarkovModel = {
    ...
    val trainer = new HiddenMarkovTrainer(hiddenStates,observableStates)
